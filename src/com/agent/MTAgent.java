...
public class MTAgent extends Agent{
...
//			if (msg != null){
//			System.out.println("MTAgent receive: "+ msg.getContent());
//			ACLMessage rec = msg.createReply();
//			rec.setContent("收到来自MCAgent的消息");
...
//				            					elementComponentList.add(e3);
				            					...
				            					msg1.addReceiver(new AID("SEAgent", AID.ISLOCALNAME));
				            					msg1.setContent(String.valueOf(e3));
				            					System.out.println("MTAgent:send: "+String.valueOf(e3));
				            					myAgent.send(msg1);
				            					break;
						            		}
