...
public class SEAgent extends Agent{
...
//			if (msg != null){
//			System.out.println("SEAgent receive: "+ msg.getContent());
//			ACLMessage rec = msg.createReply();
//			rec.setContent("收到来自MTAgent的消息");
...
//				            					elementComponentList.add(e3);
				            					...
				            					msg1.addReceiver(new AID("MEAgent", AID.ISLOCALNAME));
				            					msg1.setContent(String.valueOf(e3));
				            					System.out.println("SEAgent:send: "+String.valueOf(e3));
				            					myAgent.send(msg1);
				            					break;
						            		}
...
//						System.out.println("当前节点的名称：" + e4.getName());  
...
//								System.out.println("当前节点的名称：" + e5.getName());
...
//						System.out.println(fromComponent+"--->"+toComponent);
				...
				System.out.println("体系结构集合构造结果如下：");
